...
def proc_one(path_infile, path_outfile):
    ...
    #     notes = midi_obj.instruments[0].notes +midi_obj.instruments[1].notes
    # else:
    #     notes = midi_obj.instruments[0].notes +midi_obj.instruments[1].notes + +midi_obj.instruments[2].notes
    #
