...
if __name__ == '__main__':
    ...
    #     open(os.path.join(path_indir, eventfiles[0]), 'rb'))[0][0].keys()
    ...
    #             os.path.join(path_indir, file), 'rb'))[jj]:
